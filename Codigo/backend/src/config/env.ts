...
const envSchema = z.object({
  ...
  WHATSAPP_PROVIDER: z.enum(["meta", "web_api"]).default("meta"),
  ...
  WHATSAPP_WEBHOOK_SHARED_TOKEN: z.string().optional(),
  WHATSAPP_WEBHOOK_SHARED_TOKEN_HEADER: z.string().default("x-whatsapp-webhook-token"),
