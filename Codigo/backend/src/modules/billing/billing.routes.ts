...
const billingOrderSchema = {
  ...
  properties: {
    ...
    cobrancaStatus: { type: "string" },
    cobrancaTipoEnvio: { type: "string" },
    cobrancaDataEnvio: { type: "string" },
    cobrancaMensagem: { type: "string" },
    cobrancaCanal: { type: "string" },
    cobrancaCanalDisponivel: { type: "boolean" },
    cobrancaMotivoIndisponivel: { type: "string" },
  },
};
